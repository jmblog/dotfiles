(function() {
  ...
  Color.addExpression('hwb', strip("  hwb" + ps + "\\s*    (" + int + ")    " + comma + "    (" + percent + ")    " + comma + "    (" + percent + ")    (" + comma + "(" + float + "))?  " + pe + ""), function(color, expression) {
    var a, b, h, w, _, _ref2;
    _ref2 = this.onigRegExp.searchSync(expression), _ = _ref2[0], h = _ref2[1], w = _ref2[2], b = _ref2[3], _ = _ref2[4], a = _ref2[5];
    color.hwb = [parseInt(h.match), parseFloat(w.match), parseFloat(b.match)];

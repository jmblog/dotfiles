(function() {
  var Color, MAX_PER_COMPONENT, clamp, clampInt, comma, cssColor, float, floatOrPercent, hexa, int, intOrPercent, notQuote, parseFloatOrPercent, parseIntOrPercent, pe, percent, ps, split, strip, _ref, _ref1,
    __slice = [].slice;
  ...
  _ref1 = require('./utils'), strip = _ref1.strip, split = _ref1.split, clamp = _ref1.clamp, clampInt = _ref1.clampInt, parseIntOrPercent = _ref1.parseIntOrPercent, parseFloatOrPercent = _ref1.parseFloatOrPercent;
  ...
  Color.addExpression('sass_adjust_color', "adjust-color" + ps + "(" + notQuote + ")" + pe, 1, function(color, expression) {
    var name, param, params, refColor, subexpr, subject, value, _, _i, _len, _ref2, _ref3, _ref4;
    _ref2 = this.onigRegExp.searchSync(expression), _ = _ref2[0], subexpr = _ref2[1];
    _ref3 = split(subexpr.match), subject = _ref3[0], params = 2 <= _ref3.length ? __slice.call(_ref3, 1) : [];
    refColor = new Color(subject);
    for (_i = 0, _len = params.length; _i < _len; _i++) {
      param = params[_i];
      _ref4 = RegExp("\\$(\\w+):\\s*(-?" + float + ")").exec(param), _ = _ref4[0], name = _ref4[1], value = _ref4[2];
      refColor[name] += parseFloat(value);
    }
    return color.rgba = refColor.rgba;
  });

  Color.addExpression('sass_scale_color', "scale-color" + ps + "(" + notQuote + ")" + pe, 1, function(color, expression) {
    var dif, name, param, params, refColor, result, subexpr, subject, value, _, _i, _len, _ref2, _ref3, _ref4;
    _ref2 = this.onigRegExp.searchSync(expression), _ = _ref2[0], subexpr = _ref2[1];
    _ref3 = split(subexpr.match), subject = _ref3[0], params = 2 <= _ref3.length ? __slice.call(_ref3, 1) : [];
    refColor = new Color(subject);
    for (_i = 0, _len = params.length; _i < _len; _i++) {
  ...
  Color.addExpression('sass_change_color', "change-color" + ps + "(" + notQuote + ")" + pe, 1, function(color, expression) {
    var name, param, params, refColor, subexpr, subject, value, _, _i, _len, _ref2, _ref3, _ref4;
    _ref2 = this.onigRegExp.searchSync(expression), _ = _ref2[0], subexpr = _ref2[1];
    _ref3 = split(subexpr.match), subject = _ref3[0], params = 2 <= _ref3.length ? __slice.call(_ref3, 1) : [];
    refColor = new Color(subject);
